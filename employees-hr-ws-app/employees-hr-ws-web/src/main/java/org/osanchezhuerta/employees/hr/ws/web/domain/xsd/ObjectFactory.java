...
public class ObjectFactory {
    ...
    private final static QName _SalaryVOFromDate_QNAME = new QName("http://domain.web.ws.hr.employees.osanchezhuerta.org/xsd/", "fromDate");
    ...
    public JAXBElement<XMLGregorianCalendar> createSalaryVOFromDate(XMLGregorianCalendar value) {
        return new JAXBElement<XMLGregorianCalendar>(_SalaryVOFromDate_QNAME, XMLGregorianCalendar.class, SalaryVO.class, value);
    }
    ...
    public JAXBElement<XMLGregorianCalendar> createTitleVOFromDate(XMLGregorianCalendar value) {
        return new JAXBElement<XMLGregorianCalendar>(_SalaryVOFromDate_QNAME, XMLGregorianCalendar.class, TitleVO.class, value);
    }
